...
to setup
  ...
  set building-dataset gis:load-dataset "data/building_polygons.shp"
  set highway-dataset gis:load-dataset "data/highway_lines.shp"
  set landUse-dataset gis:load-dataset "data/landUse_polygons.shp"
  ...
  gis:set-world-envelope (gis:envelope-union-of (gis:envelope-of building-dataset)
                                                (gis:envelope-of highway-dataset)
